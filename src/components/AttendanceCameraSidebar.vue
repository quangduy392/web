<template>
    ...
    >
        ...
        >
            ...
            >
                <div>{{ this.$t('attendanceCamera.group') }}</div>
                <div class="mr-2">{{ this.$t('attendanceCamera.attendance') }}</div>
            </div>
...
export default {
    name: 'attendance-camera-sidebar',
    ...
    mounted: function() {
        this.$nextTick(async function() {
            ...
            setTimeout(() => {
                ...
                if (
                    this.currentUser.selectedAttCameras &&
                    this.currentUser.selectedAttCameras.length
                ) {
                    const previoutSelectedCameras = this.currentUser.selectedAttCameras.filter(
                        camera => camera
                    );
    ...
    methods: {
        ...mapActions({
            ...
            saveSelectedAttCameras: 'auth/saveSelectedAttCameras'
        }),
        // Camera filter
        ...
        updateFilter() {
            ...
            this.saveSelectedAttCameras(selectedCameras);
