...
export default {
    ...
    mounted: function() {
        this.$nextTick(async function() {
            ...
            setTimeout(() => {
                ...
                if (
                    this.currentUser.selectedReceptionMapCameras &&
                    this.currentUser.selectedReceptionMapCameras.length
                ) {
                    const previoutSelectedCameras = this.currentUser.selectedReceptionMapCameras.filter(
                        camera => camera
                    );
    ...
    methods: {
        ...mapActions({
            ...
            saveSelectedReceptionMapCameras: 'auth/saveSelectedReceptionMapCameras'
        }),
        // Camera filter
        ...
        updateFilter() {
            ...
            this.saveSelectedReceptionMapCameras(selectedCameras);
