            ...
            <div class="d-flex h-100">
                <div
                    :class="[
                        ...
                        fiteredProfile.length === 0 || isLoading
                ...
                >
                    <div
                        ...
                        v-if="!isLoading && fiteredProfile.length > 0"
                    >
                    ...
                    <div
                        v-if="fiteredProfile.length === 0 && !isLoading"
...
export default {
    ...
    methods: {
        ...
        async openEditModal(profileId) {
            this.resetForm();
            this.resetDataImageDetected();
            await this.getProfile({ id: profileId, type: 'staff', ntype: 'guest' });
        ...
        async onDelete(modal) {
            ...
            if (this.showDetectedImageTab === true) {
                await this.deleteImage({ id: this.currentImageId, type: 'staff', ntype: 'guest' });
        ...
        async submitForm() {
            if (this.form.id) {
                await this.updateOrCreate({ ...this.form, type: 'staff', ntype: 'guest' });
