            ...
            <template slot="sub-header-left">
                <b-navbar-nav class="d-flex flex-row">
                    <b-nav-item class="text-nowrap" active>
                        {{ $t('processMonitor.commonTitleHcc') }}
                    </b-nav-item>
                </b-navbar-nav>
            </template>
        ...
        <div class="page-content sub-header-page-content">
            <div class="d-flex h-100">
                ...
                <div class="att-cam_sidebar h-100">
                    <reception-dashboard-sidebar-hcc
...
import ReceptionDashboardSidebarHcc from '@/components/ReceptionDashboardSidebarHcc';
import EventItem from '@/components/EventItem.vue';
import CamLiveView from '@/components/CamLiveView';

export default {
    components: {
        ReceptionDashboardSidebarHcc,
        EventItem,
        CamLiveView
    },
    mounted: function() {
    ...
    computed: {
        ...mapState({
            receptionCamerasHcc: state => state.receptionhcc.receptionCameras
        }),
        sortedReceptionTimes() {
            let receptionTitleTotal = 0;
            const cameras = this.receptionCamerasHcc
    ...
    methods: {
        ...
        getCameraName(id) {
            const camera = this.receptionCamerasHcc.find(el => el.id === id);
