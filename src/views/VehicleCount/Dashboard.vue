        ...
        <div class="page-content sub-header-page-content">
            <div class="d-flex h-100">
                            ...
                            <b-col class="px-1">
                                <div class="h-100 border border-gray-500 p-2 d-flex flex-column">
                                    <div class="d-flex mb-2 pb-2 border-bottom border-gray-500">
                                        ...
                                        <router-link to="/vehicle-count/report/summary">
                                        ...
                                        <table class="table mb-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-white">
                                                        {{ $t('vehicleCount.countEntry') }}
                                                    </th>
                                                    <th class="text-white">
                                                        {{ $t('vehicleCount.countExit') }}
                                                    </th>
                                                    <th class="text-white">
                                                        {{ $t('report.sum') }}
                                                    </th>
                ...
                <div class="att-cam_sidebar att-alert_sidebar h-100">
                    <CountVehicleSidebar @doFilter="updateSelectedCameraList"></CountVehicleSidebar>
                </div>
            </div>
        </div>
...
import CountVehicleSidebar from '@/components/CountVehicleSideBar';
...
export default {
    ...
    computed: {
        ...mapState({
            ...
            statisticSummaryReport: state => state.vehicleCount.statisticSummaryReport
        })
    },
    data() {
        return {
    ...
    methods: {
        ...mapActions({
            ...
            getTodayStatistic: 'vehicleCount/getTodayStatistic',
            getEventTypeList: 'event/getEventTypes',
            getStatisticSummaryReport: 'vehicleCount/getStatisticSummaryReport'
        }),
