...
export default {
    ...
    methods: {
        ...
        async openEditModal(profileId) {
            this.resetForm();
            this.resetDataImageDetected();
            await this.getProfile({ id: profileId, type: 'guest' });
            this.form = { ...this.profileInfo };
            if (this.form.data) {
                this.welcomeMess = this.form.data.welcomeMessage;
                this.byeMess = this.form.data.byeMessage;
            }
        ...
        async onDelete(modal) {
            ...
            if (this.showDetectedImageTab === true) {
                await this.deleteImage({ id: this.currentImageId, type: 'guest' });
        ...
        async submitForm() {
            ...
            if (this.form.id) {
                await this.updateOrCreate({ ...this.form, type: 'guest' });
