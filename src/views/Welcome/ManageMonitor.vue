<template>
    <div class="animated fadeIn h-100">
        <sub-header hideBreadcrumb>
            <template slot="sub-header-left">
                <b-navbar-nav class="d-flex flex-row">
                    <b-nav-item to="/welcome/manage/guest" class="text-nowrap">{{
                        $t('welcome.manage.guest')
                    }}</b-nav-item>
                    <b-nav-item to="/welcome/manage/monitor" class="text-nowrap">{{
        ...
        <div class="page-content sub-header-page-content pb-0 p-4">
            ...
            >
                ...
                <template slot="desc" slot-scope="row">
                    <span v-line-clamp="1" v-b-tooltip.hover :title="row.value">{{
                        row.value
                    }}</span>
                </template>
        ...
        >
            ...
            <b-form-group :label="$t('common.description')">
                <b-form-textarea
                    maxlength="255"
                    name="desc"
                    v-model="form.desc"
        ...
        <b-modal
            ...
            body-class="scroll-modal-body"
        >
            <b-form-group label-cols="4" :label="$t('alert.activeInterval')">
                <b-form-input
                    maxlength="255"
                    type="number"
                    v-model="form.activeInterval"
                    name="activeInterval"
                    :placeholder="$t('alert.activeInterval')"
                ></b-form-input>
            </b-form-group>
            <b-form-group label-cols="4" :label="$t('alert.inactiveInterval')">
                <b-form-input
                    maxlength="255"
                    type="number"
                    v-model="form.inactiveInterval"
                    name="inactiveInterval"
                    :placeholder="$t('alert.inactiveInterval')"
                ></b-form-input>
            </b-form-group>
            <b-form-group
                label-cols="4"
    ...
    data: function() {
        return {
            ...
            fields: [
                ...
                {
                    class: 'align-middle monitor-desc-col',
                    key: 'desc',
